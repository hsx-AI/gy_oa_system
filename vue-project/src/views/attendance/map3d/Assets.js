...
export class Assets {
  ...
  init() {
    ...
    const assets = [
      ...
      { type: 'File', name: 'chinaStorke', path: base + 'assets/json/中华人民共和国-轮廓.json' },
      { type: 'File', name: 'china', path: base + 'assets/json/中华人民共和国.json' },
      { type: 'File', name: 'transportPath', path: base + 'assets/json/运输路径.json' },
    ]
