...
app.include_router(access_dashboard.router, prefix=settings.API_PREFIX)
...
app.include_router(shared_files.router, prefix=settings.API_PREFIX)  # 部门共享文档
app.include_router(onlyoffice.router, prefix=settings.API_PREFIX)  # ONLYOFFICE callback
